...
FURNITURE_LOOT_TABLES = {
    ...
    "서랍장": {
        "items": [
            ("붕대", 0.2), ("라이터", 0.25), ("배터리", 0.2),
            ("천", 0.3), ("못", 0.15), ("접착제", 0.1),
        ],
        "min_items": 0, "max_items": 2,
    },
    "침대밑": {
        "items": [
            ("야구방망이", 0.1), ("천", 0.25), ("라이터", 0.15),
            ("손전등", 0.08),
        ],
    ...
    "진열대": {
        "items": [
            ("식량통조림", 0.4), ("생수", 0.5), ("배터리", 0.2),
            ("라이터", 0.15), ("접착제", 0.1), ("못", 0.15),
        ],
        "min_items": 0, "max_items": 3,
    },
    "카운터": {
    ...
    "군용상자": {
        "items": [
            ...
            ("통신장비 부품", 0.08), ("비상용 배터리", 0.15),
        ],
        "min_items": 1, "max_items": 3,
    },
    "통신장비": {
        "items": [
            ("통신장비 부품", 0.4), ("배터리", 0.3), ("비상용 배터리", 0.2),
        ],
        "min_items": 0, "max_items": 1,
    },
}
